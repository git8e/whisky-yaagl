...
public struct BottleSettings: Codable, Equatable {
    ...
    /// Which Wine runtime installation is used by this bottle
    ...
    public var hk4eRegion: HK4eGame.Region {
        get { return hk4eConfig.region }
        set { hk4eConfig.region = newValue }
    }

    public var hk4eCustomResolutionEnabled: Bool {
        get { return hk4eConfig.customResolutionEnabled }
        set { hk4eConfig.customResolutionEnabled = newValue }
    }

    public var hk4eCustomResolutionWidth: Int {
        get { return hk4eConfig.customResolutionWidth }
        set { hk4eConfig.customResolutionWidth = newValue }
    }

    public var hk4eCustomResolutionHeight: Int {
        get { return hk4eConfig.customResolutionHeight }
        set { hk4eConfig.customResolutionHeight = newValue }
    }
