//
//  HKRPGWebviewFix.swift
//  WhiskyKit
//

import Foundation

public enum HKRPGWebviewFix {
    ...
    public static func applyIfNeeded(bottle: Bottle, region: HKRPGGame.Region) async {
        let key = HKRPGGame.registryKey(region: region)

        // Mirrors YAAGL behavior.
        ...
        do {
            ...
            let regURL = dir.appendingPathComponent("hkrpg_fix_webview.reg", isDirectory: false)
